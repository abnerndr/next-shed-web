export default function AcessForm() {
  return (
    <>
      <div className="flex min-h-full flex-1 pt-12 rounded-lg pl-10 ">
        <div className="relative lg:flex min-h-full flex-1 rounded-lg bg-gradient-to-r from-gray-900 via-gray-800 to-gray-700">
          <div className="flex relative">
            <span className="relative pt-96 p-20 text-gray-50 font-bold">
        ...
        <div className="flex flex-1 flex-col justify-center px- py-12 sm:px-6 lg:flex-none lg:px-20 xl:px-24">
          <div className="mx-auto w-full max-w-sm lg:w-96">
            <div>
              ...
              <p className="mt-2 text-md font-bold leading-6 text-gray-600">
              ...
              <div>
                <form action="#" method="POST" className="space-y-6">
                  <div>
                    <label
                      htmlFor="email"
                      className="block text-md font-bold leading-6 text-gray-600"
                    >
                      Email address
                    </label>
                    <div className="mt-2">
              ...
              <div className="mt-10">
                <div className="relative">
                  ...
                  <div className="relative flex justify-center text-sm font-medium leading-6">
                    <span className="bg-white px-6 text-gray-600 font-semibold">
                      Or continue with
                    </span>
                  </div>
                </div>
