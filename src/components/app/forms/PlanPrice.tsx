      ...
      <div className="bg-white shadow sm:rounded-lg">
        <div className="px-4 py-5 sm:p-6">
          <h3 className="text-base font-semibold leading-6 text-gray-900">
            Planos para genrenciar sua empresa
          </h3>
          <div className="mt-2 max-w-xl text-sm text-gray-500">
            <p>
              Um plano de agendamento comercial é uma solução eficiente e
              organizada para empresas gerenciarem seus compromissos, horários e
              disponibilidades de forma estruturada.
            </p>
          </div>
          <div className="mt-5">
            <button
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="p-4 md:p-5">
                <p className="text-gray-500 dark:text-gray-400 mb-4">
                  Selecione o melhor plano para sua empresa
                </p>
                  ...
                  <li>
                    ...
                    >
                      <div className="block">
                        ...
                        <li className="w-full text-gray-500 dark:text-gray-400">
                          agendamento
                        </li>
                        <li className="w-full text-gray-500 dark:text-gray-400">
                          gerenciamento
